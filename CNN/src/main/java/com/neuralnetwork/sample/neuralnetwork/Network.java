...
public class Network {
    ...
    private List<DenseDoubleMatrix2D> weightMatrixList = null;      //权重矩阵列表
    private List<DenseDoubleMatrix2D> biasMatrixList = null;        //偏置矩阵列表
    ...
    public void initWeightAndBais(){
        ...
        for(int i=0;i<this.layerNum-1;i++){
            int colNumber = this.sizes[i];      //列号
            int rowNumber = this.sizes[i+1];    //行号
